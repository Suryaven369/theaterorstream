...
const Footer = () => {
  return (
    // <footer classNameName="text-center bg-neutral-600 bg-opacity-35 text-neutral-400 py-2">
    //   <div classNameName="flex items-center justify-center gap-4">
    //     <Link to="/">About</Link>
    //     <Link to="/">Contact</Link>
    //   </div>
    //   <p classNameName="text-sm">Created By Kris Rego</p>
    // </footer>
      ...
      <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-center text-gray-400">
            © 2024 <a className="hover:underline">Kris Rego</a>. All Rights
            Reserved.
          </span>
