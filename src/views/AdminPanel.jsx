                ...
                {activeTab === 'dashboard' && (
                    <div>
                        ...
                        <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                            <h3 className="text-sm font-medium text-white mb-3">Content Overview</h3>
                            <div className="text-xs text-white/50 space-y-2">
                                <p>📊 Your library contains <span className="text-white font-medium">{stats.total}</span> items</p>
                                <p>🎬 <span className="text-white font-medium">{stats.movies}</span> movies and <span className="text-white font-medium">{stats.tv}</span> TV shows</p>
                                <p>⭐ <span className="text-white font-medium">{stats.featured}</span> featured items highlighted</p>
                                <p>✅ <span className="text-white font-medium">{stats.active}</span> items are currently active</p>
                            </div>
                        </div>
                    </div>
                )}
