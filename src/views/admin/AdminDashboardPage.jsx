...
const QUICK_LINKS = [
    ...
    { to: "/admin/collections", label: "Collections", icon: "🏷️", desc: "CMS tags" },
    { to: "/admin/franchise-lists", label: "List Moderation", icon: "🎬", desc: "Approve Franchise tags" },
        ...
        <div className="p-4 sm:p-6 max-w-7xl">
            ...
            <div className="mb-6 flex flex-wrap items-center gap-3 sm:gap-6">
                ...
                <button
                    onClick={loadData}
                    disabled={loading}
                    className="ml-auto px-3 py-2 text-xs rounded-lg bg-white/10 text-white/70 hover:bg-white/15 min-h-[40px]"
                >
