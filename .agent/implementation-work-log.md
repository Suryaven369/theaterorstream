...
**Last synced with `main`:** Jul 31, 2026 · HEAD `bccc214` · [github.com/Suryaven369/theaterorstream](https://github.com/Suryaven369/theaterorstream)
...
## Session: Jul 31, 2026 — Manual add on Watched in Theaters

### Add titles enabled for theater system list ✅

**Problem:** Watched in Theaters only auto-filled from diary “In theater” logs; ⋯ → Add titles was hidden.

**Files changed:** `CollectionDetails.jsx`, `CollectionsPage.jsx`, `theaterWatch.js` (copy)

**Behavior:** Owners can manually Add titles; diary sync still works; list still cannot be deleted.
...
| Commit | Date | Summary |
|--------|------|---------|
| `bccc214` | Jul 2026 | Drag-reorder collection titles in edit mode (custom sort_order) |
...
| `003fdb0` | Jul 2026 | Blogs in feed, Franchise moderation, approve-to-top RSS, admin mobile |
